...
const CategoryUpdate = (props) => {
  ...
  const categoryAPI = "http://localhost:1234/category/getcategorybyid/" + String(id);
  const updateCategoryAPI ="http://localhost:1234/category/updatecategorybyid/" + String(id);
  ...
  function updateProduct() {
    ...
    axios.put(updateCategoryAPI, sendObj).then((res) => {
        alert("Data Updated");
      });
        ...
        <div className="row">
          ...
          <div className="col-md-9 register-right">
            ...
            <div className="tab-content" id="myTabContent">
              ...
              >
                <h3 className="register-heading">Update Category</h3>
